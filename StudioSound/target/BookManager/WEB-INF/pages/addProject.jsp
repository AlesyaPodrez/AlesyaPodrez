...
<t:template>
    ...
    <form:form method="post" action="addProject" commandName="project" id="contacts-form" enctype="multipart/form-data">
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><form:input path="nameProject" pattern="^[А-Яа-яЁё\s]+$" required="required"/></td>&nbsp;&nbsp;
            </tr>
            <tr>
