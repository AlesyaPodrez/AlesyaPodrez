...
<t:template>
    <form:form method="post" action="../editRole" commandName="role" id="contacts-form">
        <table>
            <tr>
                <td> <form:input path="idRole" readonly="true" hidden="true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <form:select path="idActor" required="required">
                        <option selected value="${role.idActor.idActor}">${role.idActor.name} ${role.idActor.surname}</option>
