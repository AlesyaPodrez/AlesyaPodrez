...
<t:template>
    <form:form method="post" action="../editStaffProject" commandName="staff_project" id="contacts-form">
        <table>
            <tr>
                <td> <form:input path="idStaffProject" readonly="true" hidden="true"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select>
                        <option selected value="${staff_project.idStaff.idPost}">${staff_project.idStaff.idPost.namePost}</option>
            ...
            <tr>
                ...
                &nbsp;&nbsp;
                <td>
                    <form:select path="idStaff">
                        <option selected value="${staff_project.idStaff.idStaff}">${staff_project.idStaff.name} ${staff_project.idStaff.surname}</option>
