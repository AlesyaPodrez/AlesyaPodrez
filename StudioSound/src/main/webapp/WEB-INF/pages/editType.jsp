...
<t:template>
    <form:form method="post" action="../editType" commandName="type" id="contacts-form">
        <table>
            <tr>
                <td><form:input path="idType" readonly="true" hidden="true"/></td>
            </tr>
            <tr>
                <td><form:label path="NameType">
                    Название
                </form:label></td>
                <td><form:input path="nameType" pattern="^[А-Яа-яЁё\s]+$"/></td>&nbsp;&nbsp;
                <td><form:errors path="nameType"></form:errors> </td>
            </tr>
        </table><br>
